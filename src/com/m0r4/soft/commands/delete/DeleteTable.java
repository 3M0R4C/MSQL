 ...
 * @author e.mora.c
 */
public class DeleteTable extends MSQLMethod {
    ...
    public void paramsHelp() {
        MSQLConsole.printResult(new MSQLManual() {
            ...
            public String getDescription() {
                return "This method allows the user to delete tables on the connected database.";
            }

            @Override
            public Map<String, String> getParametersMap() {
                Map<String, String> parameters = new LinkedHashMap();
                parameters.put("NAME", "Name for the table being deleted.");
    ...
    protected void execute() {
        try {
            ...
            sql = "DROP TABLE "+name+" "+(mode.equalsIgnoreCase("FORCE")?"CASCADE":"RESTRICT");
            
            MSQLConsole.printDebug(sql);
            QueryManager.executeQuery(sql);
            MSQLConsole.printResult("Table successfully deleted!");
        } catch (Exception ex) {
